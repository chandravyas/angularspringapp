...
public class AngularspringappApp {

    private static final Logger log = LoggerFactory.getLogger(AngularspringappApp.class);

    private final Environment env;

    public AngularspringappApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes angularspringapp.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AngularspringappApp.class);
